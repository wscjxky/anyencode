namespace anyEncoder
{
    ...
    public sealed class Conn
    {
        ...
        public static readonly string connectionString = config.mssql;
        ...
        public static int ExecuteNonQuery(string storedProcName, IDataParameter[] parameters)
        {
            ...
            {
                connection.Open();
                num = BuildIntCommand(connection, storedProcName, parameters).ExecuteNonQuery();
            }
            catch (SqlException exception)
            {
                connection.Close();
        ...
        public static int ExecuteSql(string SQLString, object content)
        {
            ...
            {
                SqlCommand command = new SqlCommand(SQLString, connection);
                SqlParameter parameter2 = new SqlParameter("@content", SqlDbType.NText);
        ...
        public static int ExecuteSql(string SQLString, object content, SqlDbType dbtype)
        {
            ...
            {
                SqlCommand command = new SqlCommand(SQLString, connection);
                SqlParameter parameter2 = new SqlParameter("@content", dbtype);
                parameter2.Value = content;
                SqlParameter parameter = parameter2;
                command.Parameters.Add(parameter);
                try
        ...
        public static int ExecuteSqlInsertImg(string strSQL, byte[] fs)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    int num;
                    SqlParameter parameter2 = new SqlParameter("@fs", SqlDbType.Image);
                    parameter2.Value = fs;
                    SqlParameter parameter = parameter2;
                    command.Parameters.Add(parameter);
                    try
        ...
        public static DataSet PagerDataset(out int rowsTotal, string tableName, string fieldName, string keyName, int pageSize, int pageNow, string stringOrder, string stringWhere)
        {
            ...
            parameters[4].Value = (pageSize == 0) ? 20 : pageSize;
        ...
        public static int UpdateRecord(string tbName, string fldName, string strWhere)
        {
            ...
            num = RunProcedure("UpdateRecord", parameters, out num);
            return 0;
        }
